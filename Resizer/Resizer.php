...
namespace Ok99\PrivateZoneCore\MediaBundle\Resizer;
...
class Resizer implements \Sonata\MediaBundle\Resizer\ResizerInterface
{
    protected $adapter;
    ...
    public function getBox(MediaInterface $media, array $settings)
    {
        ...
        if ($this->mode === ImageInterface::THUMBNAIL_OUTBOUND) {
